    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Update hotel information and details</p>
            </div>
        ...
        <form action="{{ route('admin.hotels.update', $hotel) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-gradient-to-r from-primary-50 to-primary-100 px-6 py-4 border-b border-primary-200">
                <div class="flex items-center">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-800">Hotel Information</h3>
                        <p class="text-sm text-gray-600">Update the basic details of your hotel</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    type="url"
                                    name="image_url"
                                    value="{{ old('image_url', $hotel->image_path) }}"
                    ...
                    <div id="imagePreview" class="mt-4 hidden">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="text-sm text-gray-500">
                                ...
                                <p class="text-xs mt-1">This is how the new image will appear</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Activate or deactivate this hotel</p>
                    </div>
                    <div class="flex items-center space-x-4">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h5 class="font-medium text-blue-800">Update Tips</h5>
                            <ul class="text-sm text-blue-700 mt-1 space-y-1">
                                <li>• Update the image to showcase the hotel's current appearance</li>
                                <li>• Keep the description updated with the latest amenities and features</li>
                                <li>• Verify contact information for customer inquiries</li>
                                <li>• Set appropriate star rating based on hotel standards</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4">
                <div class="text-sm text-gray-500">
                    Last updated: {{ $hotel->updated_at->format('M j, Y g:i A') }}
                    @if($hotel->created_at != $hotel->updated_at)
                    <br>
                    <span class="text-xs">Created: {{ $hotel->created_at->format('M j, Y') }}</span>
                    @endif
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Add click handlers for cancel button to bypass confirmation
        document.querySelector('a[href="{{ route('admin.hotels.index') }}"]').addEventListener('click', function(e) {
